...
class PassiveProductGrid extends StatelessWidget {
  const PassiveProductGrid({super.key, required this.controller});
  ...
  Widget build(BuildContext context) {
    return GridView.builder(
      ...
      controller: controller.tabViewScrollControllers[2],

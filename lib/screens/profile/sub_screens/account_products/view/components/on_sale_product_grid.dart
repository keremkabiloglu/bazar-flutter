...
class OnSaleProductGrid extends StatelessWidget {
  const OnSaleProductGrid({super.key, required this.controller});
  ...
  Widget build(BuildContext context) {
    return GridView.builder(
      ...
      controller: controller.tabViewScrollControllers[0],
